...
function BbsUpdate() {
	...
	const [boardType, setBoardType] = useState(bbs.boardType);
	...
	return (
		<div>
			<table className="table">
				...
				<tr>
					<th className="table-primary">게시글 타입</th>
					<td>
						<span>{boardType}</span>
					</td>
				</tr>
				...
				<tr>
					<th className="table-primary">{boardType === "나눔" ? "물품명":"제목"}</th>
					<td>
				...
				<tr>
					<th className="table-primary">{boardType === "나눔" ? "물품 설명 상세글":"내용"}</th>
					<td>
